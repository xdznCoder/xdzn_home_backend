...
-- 队长账号: admin@xdzn.dev / admin123 (BCrypt $2a$10)，角色 captain（队长）
INSERT IGNORE INTO users (id, email, password, name, role) VALUES
(1, 'admin@xdzn.dev', '$2a$10$Mn8L5lhnpSJtgD8kBC54yupY6lLOSknfPvvI9fSI7Gdp1bScAVK2S', '管理员', 'captain');
...
-- members
INSERT IGNORE INTO members (id, name, direction, graduation_year, grade, major, team_role, internship, awards, `order`) VALUES
(1, '林星河', '前端', 2024, 2020, '计算机科学与技术', '负责人', '曾在互联网公司实习', '全国大学生数学建模竞赛省一等奖', 1),
(2, '陈墨', '后端', 2023, 2019, '软件工程', '核心成员', '后端技术训练营', 'ACM-ICPC 亚洲区域赛铜奖', 2),
(3, '苏晚', '算法', 2024, 2020, '数据科学与大数据技术', '核心成员', NULL, 'Kaggle 竞赛银牌', 3),
(4, '张涵', '设计', 2025, 2021, '数字媒体技术', '成员', NULL, NULL, 4),
(5, '李遥', '前端', 2025, 2021, '计算机科学与技术', '成员', NULL, NULL, 5),
(6, '周然', '运维', 2023, 2019, '网络工程', '核心成员', '云计算实习', '红帽挑战赛华东区优胜', 6),
(7, '王澈', '后端', 2024, 2020, '软件工程', '成员', NULL, NULL, 7),
(8, '赵麟', '算法', 2025, 2021, '计算机科学与技术', '成员', NULL, NULL, 8);
